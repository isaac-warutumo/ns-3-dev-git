...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream =
      ascii.CreateFileStream ("tracemetrics/dynamic-global-routing.tr");
  p2p.EnableAsciiAll (stream);
  csma.EnableAsciiAll (stream);
  internet.EnableAsciiIpv4All (stream);

  p2p.EnablePcapAll ("pcap/dynamic-global-routing");
  csma.EnablePcapAll ("pcap/dynamic-global-routing", false);
  ...
  Ptr<OutputStreamWrapper> routingStream =
      Create<OutputStreamWrapper> ("routing/dynamic-global-routing.routes", std::ios::out);
  ...
  AnimationInterface anim ("netanim/test.xml");
  anim.SetConstantPosition (c.Get (0), 10.0, 5.0);
  anim.SetConstantPosition (c.Get (1), 10.0, 30.0);
  anim.SetConstantPosition (c.Get (2), 15.0, 20.0);
  anim.SetConstantPosition (c.Get (3), 40.0, 20.0);
  anim.SetConstantPosition (c.Get (4), 25.0, 25.0);
  anim.SetConstantPosition (c.Get (5), 35.0, 25.0);
  anim.SetConstantPosition (c.Get (6), 40.0, 30.0);
